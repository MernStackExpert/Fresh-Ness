    ...
    <section className="bg-white py-6 md:py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:h-[600px]">
          ...
          {/* Left Large Banner (Text Overlay on Full Image) */}
          <motion.div 
          ...
          >
            ...
            <div className="relative z-10 p-8 md:p-16 h-full flex flex-col justify-center items-start text-white">
              ...
              <h1 className="text-4xl md:text-7xl font-bold leading-tight mb-4 drop-shadow-lg" style={{ fontFamily: 'cursive' }}>
                Fresh Organic <br /> 
              ...
              <button className="bg-indigo-700 text-white px-10 py-4 rounded-full font-bold hover:bg-white hover:text-indigo-800 transition-all duration-300 shadow-xl active:scale-95">
                Shop Now
              </button>
            </div>
          </motion.div>
          ...
          <div className="flex flex-col gap-6">
            ...
            {/* Top Small Banner (Full Image Background) */}
            <motion.div 
              whileHover={{ y: -5 }}
            ...
            >
              ...
              <div className="relative z-10 p-8 text-white h-full flex flex-col justify-between">
                <div>
                    ...
                    <p className="mt-4 text-sm font-medium opacity-90 uppercase tracking-widest">Only For <span className="text-2xl font-black text-amber-400">$12.99</span></p>
                </div>
                <button className="bg-white text-indigo-900 w-fit px-6 py-2 rounded-full text-xs font-black hover:bg-amber-400 hover:text-white transition-colors">
                  SHOP NOW
                </button>
              </div>
            </motion.div>

            {/* Bottom Row (Two Equal Banners) */}
            <div className="grid grid-cols-2 gap-6 h-1/2 min-h-[250px]">
               ...
               >
                 ...
                 <div className="relative z-10 p-4 h-full flex flex-col justify-between text-center items-center">
                    <div className="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-lg">
                        <h4 className="font-black text-[10px] md:text-xs text-indigo-900 uppercase">Baby Diaper</h4>
                    </div>
                    <button className="bg-white text-indigo-900 px-4 py-1.5 rounded-full text-[10px] font-bold shadow-md hover:bg-indigo-700 hover:text-white transition-all">
                        Buy Now
                    </button>
                 </div>
               </motion.div>
               ...
               >
                 ...
                 <div className="relative z-10 p-4 h-full flex flex-col justify-between items-center text-center">
                    <div className="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-lg">
                        <h4 className="font-black text-[10px] md:text-xs text-gray-800 uppercase">Dark Wash</h4>
                    </div>
                    <button className="bg-indigo-800 text-white px-4 py-1.5 rounded-full text-[10px] font-bold shadow-md">
                        Shop All
                    </button>
                 </div>
               </motion.div>
