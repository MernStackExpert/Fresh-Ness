        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 font-medium mt-1">
              Found {totalProducts} fresh items
            </p>
          </div>
        ...
        <aside className="w-full lg:w-1/4 lg:sticky lg:top-10 self-start">
          <div className="bg-white p-6 rounded-[32px] shadow-sm border border-gray-100 max-h-[calc(100vh-80px)] overflow-y-auto no-scrollbar">
            <div className="flex items-center gap-2 mb-8 pb-3 border-b border-gray-50">
              ...
              <h2 className="font-black text-xl text-gray-800 uppercase tracking-tighter">
                Filters
              </h2>
            </div>
            ...
            <div className="mb-8">
              <h3 className="font-bold text-gray-700 mb-4 text-xs uppercase tracking-widest">
                Category
              </h3>
              <div className="flex flex-wrap lg:flex-col gap-2">
                {["", "Vegetables", "Fruits", "Dairy", "Beverages"].map(
                  (cat) => (
                    <button
                      key={cat}
                      onClick={() => {
          ...
          {loading ? (
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="bg-gray-200 h-80 rounded-[32px] animate-pulse"
                ></div>
              ))}
            </div>
          ) : products.length > 0 ? (
            ...
            <div className="text-center py-24 bg-white rounded-[40px] border-2 border-dashed border-gray-100">
              ...
              <p className="text-gray-400 mt-2 font-medium">
                Try broadening your budget or search term.
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
