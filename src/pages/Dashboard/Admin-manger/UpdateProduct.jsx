      ...
      <div className="max-w-6xl mx-auto bg-white rounded-[2.5rem] shadow-2xl border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-indigo-900 to-blue-800 p-8 text-white flex justify-between items-center">
          <div>
            ...
            <p className="text-blue-200 mt-1 italic text-sm font-medium">
              System ID: {id}
            </p>
          </div>
          <button
            onClick={() => navigate(-1)}
            className="bg-white/10 p-3 rounded-full hover:bg-white/20 transition-all cursor-pointer"
          >
            <FaArrowLeft size={24} />
          </button>
        </div>
        ...
        >
          <section className="space-y-6">
            <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
              <FaUserShield className="text-purple-600" /> Publisher Info
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input
                  ...
                  disabled={
                    watchedAddedByName !== "N/A" && !!watchedAddedByName
                  }
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  disabled={
                    watchedAddedByEmail !== "N/A" && !!watchedAddedByEmail
                  }
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 bg-gray-50 disabled:bg-gray-200 disabled:cursor-not-allowed outline-none font-bold text-gray-600"
                />
              </div>
          ...
          <section className="space-y-6">
            <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
              <FaBoxOpen className="text-blue-600" /> Identity Details
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                <label className="text-xs font-black uppercase text-gray-500">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 focus:border-blue-500 outline-none transition-all shadow-sm"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black uppercase text-gray-500">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 focus:border-blue-500 outline-none shadow-sm"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 outline-none"
                />
              </div>
              <div className="space-y-2">
                <label className="text-xs font-black uppercase text-gray-500">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 bg-white cursor-pointer outline-none"
                >
                  {categories.map((c) => (
              ...
              {[
                ...
                <div key={item.name} className="space-y-1">
                  ...
                  <input
                    ...
                    step="0.01"
                    {...register(item.name)}
                    className="w-full p-4 rounded-xl border-none shadow-sm focus:ring-2 focus:ring-blue-400 outline-none"
                  />
                </div>
              ))}
            </div>
          ...
          <section className="space-y-8">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
                <FaImages className="text-indigo-500" /> Media & Images
              </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                ...
                {imgTab === "url" && (
                  <input
                    {...register("singleImg")}
                    className="w-full p-4 border rounded-2xl outline-none mt-2"
                    placeholder="Paste singleImg URL"
                  />
                )}
              </div>
            ...
            <div className="space-y-4 pt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {imgFields.map((f, i) => (
                  <div
                    key={f.id}
                    className="flex items-center gap-2 group bg-gray-50 p-2 rounded-2xl border shadow-sm"
                  >
                    <input
                      {...register(`images.${i}`)}
                      className="flex-1 bg-transparent px-2 text-sm outline-none"
                      placeholder="Extra Image Link"
                    />
                    <button
                      type="button"
                      onClick={() => remImg(i)}
                      className="text-red-400 p-2 hover:text-red-600 cursor-pointer"
                    >
                      <FaTrash />
                    </button>
                  </div>
              ...
              <button
                type="button"
                onClick={() => addImg("")}
                className="text-xs font-black text-indigo-600 cursor-pointer hover:underline mt-2"
              >
                + Add Image Field
              </button>
            </div>
          ...
          <section className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {varFields.map((f, i) => (
                <div
                  key={f.id}
                  className="grid grid-cols-1 sm:grid-cols-4 gap-6 bg-gray-50 p-8 rounded-[2rem] border-2 border-gray-100 relative group transition-all hover:bg-white hover:border-blue-200 shadow-sm"
                >
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full p-4 border rounded-xl outline-none bg-white"
                  ...
                  <button
                    type="button"
                    onClick={() => remVar(i)}
                    className="bg-red-50 text-red-500 h-14 rounded-xl cursor-pointer hover:bg-red-500 hover:text-white transition-all flex items-center justify-center mt-auto shadow-sm"
                  >
                    <FaTrash />
                  </button>
                </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-4">
              <label className="text-xl font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
              ...
              {featFields.map((f, i) => (
                <div key={f.id} className="flex gap-2 group">
                  <input
                    {...register(`features.${i}`)}
                    className="flex-1 p-4 border-2 border-gray-100 rounded-2xl outline-none focus:border-orange-400 transition-all shadow-sm"
                  />
                  <button
                    type="button"
                    onClick={() => remFeat(i)}
                    className="text-red-400 p-2 cursor-pointer opacity-0 group-hover:opacity-100"
                  >
                    <FaTrash />
                  </button>
                </div>
            ...
            <div className="space-y-4">
              <label className="text-xl font-bold text-gray-800 flex items-center gap-2 border-b pb-2">
                <FaTags className="text-teal-500" /> SEO Tags
              </label>
              <div className="flex flex-wrap gap-3 p-6 bg-gray-50 rounded-[2rem] border-2 border-dashed border-gray-200">
                {tagFields.map((f, i) => (
                  ...
                  >
                    <input
                      {...register(`tags.${i}`)}
                      className="text-xs font-bold w-20 outline-none bg-transparent"
                    />
                    <button
                      type="button"
                      onClick={() => remTag(i)}
                ...
                <button
                  type="button"
                  onClick={() => addTag("")}
                  className="bg-teal-600 text-white w-10 h-10 rounded-full flex items-center justify-center cursor-pointer shadow-md"
                >
                  +
                </button>
              </div>
          ...
          <section className="space-y-6">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-6 py-4 rounded-2xl border-2 border-gray-100 outline-none focus:border-indigo-500 shadow-sm"
              />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-black uppercase text-gray-500 ml-1">
              ...
              <textarea
                ...
                className="w-full p-8 border-2 border-gray-100 rounded-[2rem] h-52 outline-none focus:border-indigo-500 resize-none shadow-inner"
              />
            </div>
          </section>
          ...
          <section className="flex flex-wrap gap-8 p-10 bg-gray-900 rounded-[2.5rem] shadow-xl">
            {["isNew", "isFeatured", "isActive"].map((item) => (
              ...
              >
                ...
                />
                <span className="font-bold text-gray-300 capitalize group-hover:text-blue-400">
                  {item.replace("is", "")}
                </span>
              </label>
            ))}
          ...
          <footer className="flex flex-col sm:flex-row justify-end gap-6 pt-10 border-t-2 border-gray-50">
            <button
              type="button"
              onClick={() => navigate(-1)}
              className="px-10 py-5 rounded-2xl border-2 border-gray-200 font-black text-gray-400 hover:bg-red-50 hover:text-red-500 hover:border-red-100 cursor-pointer transition-all active:scale-95"
            >
              Discard Changes
            </button>
            <button
              type="submit"
              disabled={loading}
              className="px-16 py-5 rounded-2xl bg-indigo-600 text-white font-black shadow-2xl hover:bg-indigo-700 hover:-translate-y-1 transition-all cursor-pointer flex items-center gap-2 active:scale-95 disabled:opacity-50"
            >
