      ...
      try {
        ...
        if (res.status === 200) {
          ...
          Swal.fire({
            icon: "success",
            title: "Restored!",
            text: "Order is now in Pending list.",
            timer: 1000,
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="text-red-100 text-xs uppercase font-bold tracking-widest mt-1">
                Order Rejections • {orders.length} orders
              </p>
            </div>
                          ...
                          <td className="px-6 py-4 rounded-r-2xl border-y border-r border-gray-100 text-center">
                            <div className="flex justify-center gap-3">
                              <Link
                                ...
                                className="w-10 h-10 flex items-center justify-center bg-gray-100 text-gray-600 rounded-xl hover:bg-gray-800 hover:text-white transition-all shadow-sm"
                              >
                                <FaEye size={14} />
                              </Link>
                              <button
                              ...
                              <button
                                ...
                                className="w-10 h-10 flex items-center justify-center bg-red-50 text-red-500 rounded-xl hover:bg-red-600 hover:text-white transition-all"
