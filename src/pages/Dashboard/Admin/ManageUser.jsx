  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-3xl font-black text-gray-900 tracking-tight">Manage Users</h2>
                    ...
                    <td className="px-8 py-5">
                      <div className="flex justify-center gap-2">
                        <button
                          ...
                          className={`p-2.5 rounded-xl border transition-all ${user.role === "user" ? "bg-gray-900 text-white border-gray-900 shadow-lg" : "bg-white text-gray-400 hover:text-gray-900"}`}
                          title="User Role"
                        >
                          <FiUser size={16} />
                        </button>
                        <button
                          ...
                          className={`p-2.5 rounded-xl border transition-all ${user.role === "manager" ? "bg-indigo-600 text-white border-indigo-600 shadow-lg shadow-indigo-100" : "bg-white text-gray-400 hover:text-indigo-600"}`}
                          title="Manager Role"
                        >
                          <FiShield size={16} />
                        </button>
                        <button
                          ...
                          className={`p-2.5 rounded-xl border transition-all ${user.role === "admin" ? "bg-red-600 text-white border-red-600 shadow-lg shadow-red-100" : "bg-white text-gray-400 hover:text-red-600"}`}
                          title="Admin Role"
                        >
                          <FiStar size={16} />
                        </button>
