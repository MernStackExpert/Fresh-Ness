          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                <div onClick={() => setPaymentMethod("COD")} className={`p-4 border-2 rounded-2xl cursor-pointer flex items-center gap-4 transition-all ${paymentMethod === "COD" ? "border-green-600 bg-green-50" : "border-gray-100"}`}>
                  <IoCashOutline size={24} className={paymentMethod === "COD" ? "text-green-600" : "text-gray-400"} />
                  <span className={`font-bold ${paymentMethod === "COD" ? "text-green-600" : "text-gray-700"}`}>Cash on Delivery</span>
                </div>
                <div onClick={() => setPaymentMethod("Online")} className={`p-4 border-2 rounded-2xl cursor-pointer flex items-center gap-4 transition-all ${paymentMethod === "Online" ? "border-green-600 bg-green-50" : "border-gray-100"}`}>
                  <IoCardOutline size={24} className={paymentMethod === "Online" ? "text-green-600" : "text-gray-400"} />
                  <span className={`font-bold ${paymentMethod === "Online" ? "text-green-600" : "text-gray-700"}`}>Online Payment</span>
                </div>
              </div>
