...
import { IoMailOutline, IoLockClosedOutline, IoPersonOutline, IoImageOutline } from "react-icons/io5";
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100">
        ...
        <form className="mt-8 space-y-5" onSubmit={handleRegister}>
          ...
          <div className="relative">
            <IoImageOutline className="absolute left-4 top-4 text-gray-400" size={20} />
            <input
              name="photo"
              type="url"
              required
